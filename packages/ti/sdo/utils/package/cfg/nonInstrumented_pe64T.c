...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[4965];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /db/vtree/library/trees/ipc/ipc-h32/src/ti/sdo/utils/package/cfg/nonInstrumented_pe64T");
...
/* charCnt__C */
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1365;
